...
public class PopUpWindows : MonoBehaviour
{
   ...
   public void ErrorWindow(string _text, UnityAction _onClose = null)
    ...
    public void TextInputWindow(string _inputLabel, UnityAction<string> _confirm, UnityAction _cancel = null, string _confirmButtonLabel = null, string _cancelButtonLabel = null, InputField.ContentType _contentType = InputField.ContentType.Standard)
    {
        GameObject window = InstantiateWindow(confirmationWindowPrefab);
        ConfirmationWindow verify = window.GetComponent<ConfirmationWindow>();
